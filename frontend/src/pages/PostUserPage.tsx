...
import { getPostsPaginated, postOrder, getAllOrders } from "../features/posts/postService";
      ...
      <div className="w-full lg:w-96 bg-slate-900 p-8 rounded-3xl text-white h-fit sticky top-6">
        ...
        <div className="space-y-4 mb-6">
          ...
          <div className="relative">
            ...
            >
              ...
              <option value="">
                {availableTables.length === 0 ? "Meja Penuh" : "Pilih Meja"}
              </option>
              ...
              >
                ...
                <div className="flex flex-col">
                  ...
                  <span className="text-xs text-slate-400">
                    {item.qty}x • Rp {harga.toLocaleString()}
                  </span>
        ...
        <div className="space-y-4">
          ...
          <button
            ...
            disabled={mutation.isPending || cart.length === 0 || availableTables.length === 0}
