...
export default function CategoryPage() {
  ...
  const [error, setError] = useState(""); // State untuk menampung pesan error validasi
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // Validasi: Jika input kosong atau hanya spasi
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-100 to-slate-200 p-6 text-left">
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => {
                      ...
                      if (e.target.value.trim()) setError(""); // Hapus error saat user mengetik
                    }}
                    // Beri border merah jika ada error
                  ...
                  {isLoading ? (
                    <TableRow>
                      <TableCell colSpan={3} className="text-center py-12">
                        ...
                        <p className="mt-3 text-slate-500">Memuat data kategori...</p>
                      </TableCell>
                    </TableRow>
                          ...
                          {editingId === cat.id ? (
                            <div className="flex justify-end gap-2">
                              <Button
                                ...
                                onClick={() => {
                                  if (!editValue.trim()) return alert("Nama tidak boleh kosong!");
